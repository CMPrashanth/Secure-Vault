...
const Login = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      await apiClient.post("/auth/forgot-password", formBody);
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      await apiClient.post("/auth/verify-otp", formBody);
      ...
      toast({ title: "Invalid OTP", description: errorMessage, variant: "destructive" });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      await apiClient.post("/auth/reset-password", formBody);
